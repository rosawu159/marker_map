...
@st.cache_resource
def init_connection():
    return client = pymongo.MongoClient("mongodb+srv://st.secrets.db_username:st.secrets.db_pswd@st.secrets.cluster_namezskuvse.mongodb.net/?appName=mongosh+2.2.5")
